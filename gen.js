IncomingMessage {
  ...
  socket:
   Socket {
     ...
     _peername: { address: '::1', family: 'IPv6', port: 61221 },
     [Symbol(asyncId)]: 29,
     [Symbol(bytesRead)]: 0,
     [Symbol(asyncId)]: 30,
  ...
  _startAt: [ 115156, 423473016 ],
  _startTime: 2018-02-18T01:27:20.044Z,
  _remoteAddress: '::1',
  body: { word: 'homme', 'dict[from]': 'fra', 'dict[to]': 'eng' },
  _body: true,
  length: undefined,
  read: [Function],
  route: Route { path: '/trans', stack: [ [Object] ], methods: { post: true } } }
